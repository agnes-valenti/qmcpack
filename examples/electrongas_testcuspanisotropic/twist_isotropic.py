...
EkinInf=  4.1963*1e-23 #4.9616599741533115*1e-23
EnergyInf=-6.9999*1e-22+EkinInf
...
# In[35]:
Eta=1.0 #5.79  #1.0 #5.79  #1.0 #5.79
...
etatildeValue=1.0 #1.7609294853520199  #1.0 #1.7609294853520199
if sym_ind==1:
...
for offset_x in kxoffsets:
  for offset_y in kyoffsets: 
    ...
    k1y=np.linspace(-2*kFmax+0.0,2*kFmax+0.0,Nky)
