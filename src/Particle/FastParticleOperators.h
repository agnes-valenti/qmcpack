...
struct ApplyBConds<ParticleAttrib<TinyVector<T, 2>>, Tensor<T, 2>, 2>  //
{
                               ...
                               int last)
  {
    ...
    T g00 = G[0], g01 = G[1], g10 = G[2], g11 = G[3];
    T r00 = R[0], r01 = R[1], r10 = R[2], r11 = R[3];
...
#pragma ivdep
  ...
  {
    SUPERCELL_BOUNDARY_LIMITS(T);
    T g00 = G[0], g01 = G[1], g10 = G[2], g11 = G[3]; //AV g12 = G[5], g20 = G[6], g21 = G[7], g22 = G[8];
#pragma ivdep
    for (int i = first; i < last; i++)
    {
      T x(pin[i][0] * g00 + pin[i][1] * g10);
  ...
  {
    SUPERCELL_BOUNDARY_LIMITS(T);
    T r00 = R[0], r01 = R[1], r10 = R[2], r11 = R[3]; // r12 = R[5], r20 = R[6], r21 = R[7], r22 = R[8];
#pragma ivdep
    for (int i = first; i < last; i++)
    {
...
#pragma ivdep
  ...
  {
    SUPERCELL_BOUNDARY_LIMITS(T);
    T g00 = G[0], g01 = G[1], g10 = G[2], g11 = G[3]; //g12 = G[5], g20 = G[6], g21 = G[7], g22 = G[8];
    T r00 = R[0], r01 = R[1], r10 = R[2], r11 = R[3]; //r12 = R[5], r20 = R[6], r21 = R[7], r22 = R[8];
#pragma ivdep
    for (int i = first; i < last; i++)
    {
