 ...
 */
#ifndef QMCPLUSPLUS_2DEWALD_HANDLER_H
#define QMCPLUSPLUS_2DEWALD_HANDLER_H
...
public:
  ...
  inline mRealType evaluateSR_k0() const override { return 2.0 * std::sqrt(M_PI) / (Sigma * Volume); }

  inline mRealType evaluateLR_r0() const override { return 2.0 * Sigma / std::sqrt(M_PI); }
  ...
  mRealType evaluate_vlr_k(mRealType k) const override;  //AV added
