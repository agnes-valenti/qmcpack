...
{
  std::cout<<"AV entering QMCDriverFactory::createQMCDriver (class QMCDriverInterface)"<<std::endl;
  ///////////////////////////////////////////////
  ...
  std::cout<<"AV exiting QMCDriverFactory::createQMCDriver (class QMCDriverInterface)"<<std::endl<<std::endl;
  return new_driver;
}
} // namespace qmcplusplus
