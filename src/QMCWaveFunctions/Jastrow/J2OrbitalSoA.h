...
protected:
  ...
  aligned_vector<valT> cur_v, cur_dvdx, cur_dvdy, cur_d2vdx2, cur_d2vdy2;

  aligned_vector<valT> old_u, old_du, old_d2u;
  aligned_vector<valT> old_v, old_dvdx, old_dvdy, old_d2vdx2, old_d2vdy2;


  aligned_vector<valT> DistCompressed;
  aligned_vector<valT> DisplCompressedX;
  aligned_vector<valT> DisplCompressedY;
...
public:
  ...
  valT computeU(const ParticleSet& P, int iat, int numpar, const DistRow& dist, const DisplRow& displ);
